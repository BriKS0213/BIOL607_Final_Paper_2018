...
knitr::kable(tidy(Anova(Season_Binomial)), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(Anova(color_lm)), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(color_em), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(Size_em), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(eelgrass_logit), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(Anova(eelgrass_logit)), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(eelgrass_em), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(eelgrass_tukey), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(fucus_logit), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(Anova(fucus_logit)), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(fucus_em), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(tidy(fucus_tukey), digits=3) %>% kableExtra::kable_styling("striped")
```
...
knitr::kable(Mixed_Beta_Results) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
